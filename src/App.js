...
function App() {
  ...
  React.useEffect(() => {
    axios.get('https://69ca7da1ba5984c44bf3477b.mockapi.io/items').then((res) => { setItems(res.data); });
    axios.get('https://69ca7da1ba5984c44bf3477b.mockapi.io/cart').then((res) => { setCartItems(res.data); });
    axios.get('https://69cae5f4ba5984c44bf3f7d1.mockapi.io/favs').then((res) => { setFavorites(res.data); });
    axios.get('https://69cae5f4ba5984c44bf3f7d1.mockapi.io/orders').then((res) => { setOrders(res.data); });
  }, []);
  ...
  const onAddToCart = (obj) => {
    ...
    if (findItem) {
      ...
      axios.post('https://69ca7da1ba5984c44bf3477b.mockapi.io/cart', obj).then((res) => {
  ...
  return (
    <div className="wrapped">
      {cartOpened ? (
        <Drawer items={cartItems} onClose={() => setCartOpened(false)} onRemove={onRemoveItem} onOrder={onOrder} />
      ) : null}
      ...
      <Routes>
          ...
          <div className="content">
            <div className="content2 d-flex">
              ...
              <div className="search-block">
                ...
                {searchValue && <img onClick={() => setSearchValue('')} className="removeSearch" src={process.env.PUBLIC_URL + '/img/btn-remove.svg'} alt="Remove" />}
        ...
        <Route path="/favorites" element={
          <Favorites favorites={favorites} onFavorite={onAddFav} onPlus={onAddToCart} cartItems={cartItems} />
        } />
